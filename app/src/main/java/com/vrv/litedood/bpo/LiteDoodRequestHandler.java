 ...
 */
public class LiteDoodRequestHandler extends RequestHandler {
    public static  final String TAG = LiteDoodRequestHandler.class.getSimpleName();
    ...
    public LiteDoodRequestHandler(int handlerType, Context context) {
        super(context);
