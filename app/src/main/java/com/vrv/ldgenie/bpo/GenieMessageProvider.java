 ...
 */
public class GenieMessageProvider extends ContentProvider {
    private static final String TAG = GenieMessageProvider.class.getSimpleName();
    ...
    public static final String DB_NAME = ldGenieApplication.APP_ID + ".db";
